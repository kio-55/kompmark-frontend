...
import firstImage from "./images/vangough.jpg";
        ...
        <div className="news__inner">
          ...
          <div className="news__list">
            {news.map((post) => {
              ...
              return <div className="news__post">
                  { image }
                  ...
                  <div className="news__post-footer">
                    <p className="news__post-date">{new Date(post.createdAt).toLocaleDateString()}</p>
                      <Link className="news__post-button" to={`/news/${post._id}`}>Подробнее</Link>
                    </div>
                  </div>;
            })}
          </div>
